...
class Data(Base):
    ...
    def isDataPanelVisible(self, isDataPanelVisible):
        ...
        pass
    @property
    def personalUseLimits(self):
        """
        If the user is running with a 'Fusion 360 for Personal Use license', this property will return a peronalUseLimits object which provides information about file limits associated with the license. If the user is running with any other license type, this property will return null.
        """
...
class DataFile(Base):
    ...
    def isReadOnly(self):
        """
        Gets if this file is currently read-only or not. A file can be read-only for various reasons. For example, if you are running with a 'Fusion 360 for Personal Use license' and have not designate the file to be editable or if someone else is editing the file.
        """
        return bool()
